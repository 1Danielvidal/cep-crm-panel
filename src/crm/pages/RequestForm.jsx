    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const personaPayload = {
                tipo_persona: formData.tipo_persona, nombres: formData.nombres, apellidos: formData.apellidos,
                sexo: formData.sexo, telefono_principal: formData.telefono_principal, email: formData.email,
                direccion: formData.direccion, barrio_ciudad: formData.barrio_ciudad,
                estado_espiritual: formData.estado_espiritual, invita_por: formData.invita_por,
            ...
            const solicitudPayload = {
                ...
                tipo_solicitud: formData.tipo_solicitud, origen: formData.origen,
                descripcion_breve: formData.descripcion_breve, prioridad: formData.prioridad,
                estado: 'PENDIENTE', fecha_limite_contacto: formData.fecha_limite_contacto || null,
            ...
            alert("¡Persona y Solicitud guardadas con éxito! 🕊️");
            navigate('/solicitudes');
        } catch (error) {
            console.error('Error al guardar:', error);
            alert("Error al guardar: Verifica que llenaste los campos obligatorios.");
        } finally {
            setLoading(false);
        }
    };
